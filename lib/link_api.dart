...
const String linkRenewDelete ="$linkServerName/renewal_subscriptions/delete.php";
const String linkRenewView ="$linkServerName/renewal_subscriptions/view.php";

const String linkRenewSearch ="$linkServerName/renewal_subscriptions/search.php";
  //recive just barcode 
  const String linkRenewUsersSearch ="$linkServerName/renewal_subscriptions/users_search.php";
  //recive start and end date
  const String linkRenewDateSearch ="$linkServerName/renewal_subscriptions/date_search.php";

//attendance 
  // add
const String linkAttendanceAddSub ="$linkServerName/attendance/add_sub.php";
const String linkAttendanceAddInvitation ="$linkServerName/attendance/add_invitation.php";
const String linkAttendanceAddService ="$linkServerName/attendance/add_service.php";
const String linkAttendanceAddSesstion ="$linkServerName/attendance/add_sessions.php";
  // delete
const String linkAttendanceDelete ="$linkServerName/attendance/delete.php";
  //view
const String linkAttendanceView ="$linkServerName/attendance/view.php";
const String linkAttendanceViewDay ="$linkServerName/attendance/daily_view.php";

const String linkAttendanceSearch ="$linkServerName/attendance/search.php";
  //recive just barcode 
  const String linkAttendanceUsersSearch ="$linkServerName/attendance/users_search.php";
  //recive start and end date
  const String linkAttendanceDateSearch ="$linkServerName/attendance/date_search.php";
